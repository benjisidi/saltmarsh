...
# A Tense Day
Tiresias spends the next day sketching the daegon from memory, and uses *comprehend languages* to make sense of the runes on their skin. It seems to be part of some sort of binding spell.
...
# The Dark Jungle
The party gathers on the deck of the ship
# Executive Summary
